...
class RegisterPage {
    ...
    get checkadd() { return $("//span[.='Proceed to checkout']")}
    ...
    getMonth() {
        return this.month.selectByAttribute('value', '4');
    }

    getYear() {
        return this.year.selectByAttribute('value', '2000');
    }
    ...
    getCheckadd() {
        elementPage.scrollView(this.checkadd);
        elementPage.doClick(this.checkadd);
    }
